...
panasonic_ns = cg.esphome_ns.namespace("panasonic_ckp")
PanasonicCkpClimate = panasonic_ns.class_("PanasonicCkpClimate", climate_ir.ClimateIR)

Protocol = panasonic_ns.enum("Protocol")
PROTOCOLS = {
...
CONFIG_SCHEMA = cv.All(
    climate_ir.climate_ir_with_receiver_schema(PanasonicCkpClimate).extend(
        {
...
async def to_code(config):
    ...
    cg.add_library("tonia/HeatpumpIR", "1.0.39")
    #cg.add_library("myheatpumpir=symlink:///home/davidw/git/tmp/github/arduino-heatpumpir", "")
    #cg.add_library("myheatpumpir=symlink:///home/davidw/git/tmp/mygithub/arduino-heatpumpir", "")
